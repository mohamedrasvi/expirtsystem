...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <meta name="description" content="Administration Panel - <?php print(SITE_NAME);?>">
        ...
        <link rel="shortcut icon" href="<?php print($siteBaseUrl);?>contents/admin/<?php print($siteBaseUrl);?>contents/admin/img/favicon.ico">
            ...
            <header class="navbar navbar-inverse">
                ...
                <div class="navbar-inner remove-radius remove-box-shadow">
                    ...
                    <div class="container-fluid">
                        ...
                        <!-- Logo -->
                        <a href="<?php print($siteBaseUrl);?>" class="brand">

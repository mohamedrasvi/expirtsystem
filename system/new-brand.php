...
if($_POST){
    ...
    $mail->Subject = "A new brand added by ".$_SESSION['userFullName']." - ".SITE_NAME;
    ...
    $mail->SetFrom(SITE_EMAIL_ADDRESS, SITE_NAME);
    $mail->Subject = "The brand ".$brand_name." waiting in a queue ".SITE_NAME;
    $msg = "The brand : ".$brand_name."and Tags : ".$brand_tags." successfully added to system. The reports will be ready in 48 hrs for this brand.<BR/><BR/> Thanks<BR/>".SITE_NAME;
    $mail->MsgHTML($msg);
...
<div id="page-content">
    ...
    <h3 class="page-header page-header-top">Add New Brand</h3>

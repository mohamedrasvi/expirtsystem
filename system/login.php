...
if($_POST){
    ...
    $SQL_USER = "SELECT * FROM tbl_members WHERE email_address = '".$username."' AND password_2 = '".$encPassword."'";
...
<html class="no-js">
    <head>
        ...
        <title>Yegga - Corporate Brand Management Solutions - User Login</title>

        <meta name="description" content="Yegga - Corporate Brand Management Solutions - User Login">
       ...
       <link rel="icon" href="<?php print($siteBaseUrl);?>favicon.ico" type="image/x-icon"/>
        <link rel="apple-touch-icon" href="<?php print($siteBaseUrl);?>contents/home/img/apple-touch-icon.png">
        <link rel="apple-touch-icon" sizes="57x57" href="<?php print($siteBaseUrl);?>contents/home/img/apple-touch-icon-57x57-precomposed.png">
        <link rel="apple-touch-icon" sizes="72x72" href="<?php print($siteBaseUrl);?>contents/home/img/apple-touch-icon-72x72-precomposed.png">
        <link rel="apple-touch-icon" sizes="114x114" href="<?php print($siteBaseUrl);?>contents/home/img/apple-touch-icon-114x114-precomposed.png">
        <link rel="apple-touch-icon-precomposed" href="<?php print($siteBaseUrl);?>contents/home/img/apple-touch-icon-precomposed.png">
        <!-- END Icons -->
        ...
        <link rel="stylesheet" href="<?php print($siteBaseUrl);?>contents/home/css/bootstrap.css">

        <!-- Related styles of various javascript plugins -->
        <link rel="stylesheet" href="<?php print($siteBaseUrl);?>contents/home/css/plugins.css">

        <!-- The main stylesheet of this template. All Bootstrap overwrites are defined in here -->
        <link rel="stylesheet" href="<?php print($siteBaseUrl);?>contents/home/css/main.css">
        <!-- END Stylesheets -->

        <!-- Modernizr (Browser feature detection library) & Respond.js (Enable responsive CSS code on browsers that don't support them) -->
        <script src="<?php print($siteBaseUrl);?>contents/home/js/vendor/modernizr-2.6.2-respond-1.1.0.min.js"></script>
    </head>
        ...
        <div id="login-container">
          ...
          <!-- Login Buttons -->
            <div id="login-buttons">
                <h5 class="page-header-sub">User Login</h5>
                        <!-- Login Form -->

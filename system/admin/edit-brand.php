...
if($_POST){
    ...
    if($brand_logo != ""){
        ...
        $SQL_UPDATE = "UPDATE `tbl_brands` SET `tbl_member_id` = '".$memberId."',`brand_name` = '".$brand_name."', `brand_logo` = '".$brand_logo."', `brand_tags` = '".$brand_tags."',`modified_on` = '".$modified_on."', `country_name` = '".$country_name."', `sector` = '".$sector."', `is_status` = '".$is_status."' WHERE `id` = '".$brandId."'";
        
    } else {
        
         $SQL_UPDATE = "UPDATE `tbl_brands` SET `tbl_member_id` = '".$memberId."',`brand_name` = '".$brand_name."', `brand_tags` = '".$brand_tags."',`modified_on` = '".$modified_on."', `country_name` = '".$country_name."', `sector` = '".$sector."', `is_status` = '".$is_status."' WHERE `id` = '".$brandId."'";
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <select id="cmbMemberId" name="cmbMemberId" class="input-xlarge">
                                         ...
                                         <option value="<?php print($member_row['id']);?>" <?php if($theMemberId == $member_row['id']){?> selected="selected" <?php } ?> ><?php print($member_row['full_name']);?>(<?php print($member_row['company_name']);?>)</option>
                                         <?php } ?>
                                    </select>
                                </div>
                            </div>

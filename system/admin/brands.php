...
$SQL_BRANDS = "SELECT * FROM tbl_brands" . $limit;
                ...
                <tr>
                    ...
                    <td class="span3 text-center">
                        ...
                        <div class="btn-group">
                            ...
                            <a href="results-ready-mail.php?id=<?php print($BRAND_ROW['id']); ?>" data-toggle="tooltip" title="Send brand ready email" class="btn btn-mini btn-success"><i class="icon-envelope"></i></a>
                        </div>
                    </td>
                </tr>
                <?php

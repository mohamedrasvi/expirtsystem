...
$SQL_MEMBERS_COUNT = "SELECT count(id) as tot FROM tbl_user";
...
$SQL_MEMBERS = "SELECT * FROM tbl_user";
...
<div id="page-content">
    ...
    <h3 class="page-header page-header-top">Users</h3>
    ...
    <table class="table">
        <thead>
            <tr>
                ...
                <th class="hidden-phone">Is Enabled</th>
        ...
        <tbody>
            ...
            while ($MEMBERS_ROW = mysql_fetch_array($RS_MEMBERS)) {
                ...
                <tr>
                    ...
                    <td><a href="#"><?php print($MEMBERS_ROW['fullname']); ?></a></td>
                    <td class="hidden-phone"><?php print($MEMBERS_ROW['email']); ?></td>
                    <td class="hidden-phone"><?php print($MEMBERS_ROW['is_enabled']); ?></td>
                    <td class="span3 text-center">

                        <div class="btn-group">
                            <a href="edit-user.php?id=<?php print($MEMBERS_ROW['id']); ?>" data-toggle="tooltip" title="Edit" class="btn btn-mini btn-success"><i class="icon-pencil"></i></a>
                            <a href="delete-user.php?id=<?php print($MEMBERS_ROW['id']); ?>" data-toggle="tooltip" title="Delete" class="btn btn-mini btn-danger"><i class="icon-remove"></i></a>
                        </div>
                    </td>
                </tr>
                <?php
